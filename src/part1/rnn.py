...
class RNNModule(nn.Module):
    ...
    def __init__(self, CNN, optimizer_type):
        ...
        self.TEXT = data.Field(tokenize='spacy', tokenizer_language = 'en_core_web_sm', include_lengths = True)
        ...
        self.model = RNN(self.INPUT_DIM, self.EMBEDDING_DIM, self.HIDDEN_DIM, self.OUTPUT_DIM, self.N_LAYERS,
                    self.BIDIRECTIONAL, self.DROPOUT, self.PAD_IDX)
    ...
    def forward(self):
        ...
        self.model.load_state_dict(torch.load('rnn-model.pt'))
...
if __name__ == '__main__':
    ...
    rnnmodule = RNNModule(RNN, str(optimizer))
    rnnmodule()
